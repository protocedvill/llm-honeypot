"""Session-scoped encryption for the reasoning-ladder canary breadcrumb.
...
(see library.py) plants something that needs a key to reverse, instead of
plain base64, which needs none and leaks an http:// crib in its prefix.
"""
